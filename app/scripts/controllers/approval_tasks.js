 ...
 * @ngdoc function
 * @name majiApp.controller:ApprovalTasksCtrl
 * @description
 * # ApprovalTasksCtrl
 * Controller of the ApprovalTasksCtrl
 */

app.controller('ApprovalTasksCtrl', function ($scope, $http, appService, $cookieStore, $state, $mdDialog, $mdToast, $animate, $rootScope) {
    //get config
