...
/**
 * @ngdoc function
 * @name majiApp.controller:AccountsNotBilledCtrl
 * @description
 * # AccountsNotBilledCtrl
 * Controller of the majiApp
 */

app.controller('AccountsNotBilledCtrl', function($scope, $http, appService, $cookieStore, $state, $mdDialog, $mdToast, $animate, $rootScope, $stateParams) {
  ...
  $scope.generate = function(form) {
    ...
    appService.getAccountsNotBilledReport(params).success(function(response) {
      $scope.progress = false;
      $scope.error = false;
